...
def callback_img(img):
    ...
    cv2.putText(cv_image, 'H:{:0.2f}'.format(height), (400, 340), cv2.FONT_HERSHEY_PLAIN, 1.5, (255, 0, 0), 2)
    cv2.putText(cv_image, 'S:{:0.2f}'.format(shoulder), (400, 360), cv2.FONT_HERSHEY_PLAIN, 1.5, (255, 0, 0), 2)
    cv2.putText(cv_image, 'F:{:0.2f}'.format(face) , (400, 380), cv2.FONT_HERSHEY_PLAIN, 1.5, (255, 0, 0), 2)
    cv2.putText(cv_image, 'D:{:0.2f}'.format(distance), (400, 400), cv2.FONT_HERSHEY_PLAIN, 1.5, (255, 0, 0), 2)
    cv2.putText(cv_image, 'F:{:0.2f}'.format(volFace), (400, 420), cv2.FONT_HERSHEY_PLAIN, 1.5, (255, 0, 0), 2)
