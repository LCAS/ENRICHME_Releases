    ...
    if len(msg.pos_x)>0:
        ...
        for detNo in range(0,len(msg.pos_x)):
            ...
            for prsNo in range(0,len(pix_kinect_array)):
                ...
                #print (prsNo,pix_kinect_array[prsNo])
                #print detpix_kinect
...
if __name__ == '__main__':
    ...
    #image_msg = rospy.Subscriber('/camera/depth/image_rect', Image,callbackImage)
    caminfo_msg = rospy.Subscriber('/camera/depth/camera_info', CameraInfo,callbackCamInfo)
