...
PointCloudData::PointCloudData(const Camera &camera, const Matrix<double> &depth_map)
    : X(depth_map.total_size(), -1), Y(depth_map.total_size(), -1), Z(depth_map.total_size(), -1)
{
    ...
    double zVal = depth_map.data()[108799];
    //ROS_INFO("w:%i, z:%f, c20:%f, c00:%f, c21:%f, c11:%f",width,zVal,c20,c00,c21,c11);
}
