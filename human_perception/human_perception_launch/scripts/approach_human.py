...
speechs=["Hello. I am the enrich me robot.", "I will assist you in your daily life.","I can monitor your health status all day and night","I can remind the events in your schedule","Do you know about the article in The ITV website?"]
# Times newspaper on Adele's new album?"
...
#    print('seq %d' % msg.header.seq)
    if len(msg.poses)>0:
        ...
        global robot_busy
        if math.fabs(msg.header.stamp.secs-prev_sec_peopletracker)>=7:
            prev_sec_peopletracker = msg.header.stamp.secs
            if robot_busy==False:
